...
export default function LanguageSelectorTwo() {
...
<svg
  ...
  return (
    <div className="relative inline-block text-left -z-0" ref={dropdownRef}>
      <button
        type="button"
        className={`flex items-center gap-2 z-10 relative py-2 px-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all ${
