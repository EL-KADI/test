      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <section className="text-center mb-20">
          ...
          <div className="bg-white mt-4 rounded-md shadow-[0_0_20px_0_rgba(0,0,0,0.08)] relative flex items-center justify-center flex-wrap gap-2 py-8">
            ...
            <Image width={350} height={350} className="relative z-10" src="payments.svg" alt={t("payment.title")} />
            {/* Text */}
            <h1 className="relative z-10 text-black">{t("payment.description")}</h1>
            {/* Decorative SVG - Bottom Right */}
            <Image width={120} height={120} className="absolute right-0 bottom-0" alt="bg" src="/br.svg" />
            {/* Decorative SVG - Top Left */}
            <Image width={125} height={125} className="absolute left-0 top-0" alt="bg" src="/topleft.svg" />
          </div>
        </section>
      </div>
