...
import PartnersSectionTwo from "../components/partners-section-two";
    ...
    <>
      ...
      <div className="relative text-white w-full hero">
        ...
        <div className="absolute top-16 left-1/2 text-center transform -translate-x-1/2 mt-10 w-full px-6">
          ...
          <p className="text-white">{t("paymentSection.description")}</p>
          <div className=" hover:bg-transparent transition duration-200 hover:text-[#092346] hover:bg-white border-2 hover:border-2 hover:border-white text-white rounded-md px-12 py-2 w-fit mx-auto cursor-pointer font-bold mt-4">
            <p>{t("paymentMethodsSection.title")}</p>
          </div>
        </div>
      </div>
