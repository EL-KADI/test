...
const PerformanceTracking = () => {
  ...
  return (
    ...
    >
      <img
        className={`absolute -bottom-20 ${isRTL ? 'right-0' : 'right-0'} z-20`}
        alt={t('performanceTracking.mobileAlt')}
        src="/mobile.svg"
      />
      <img
        className={`absolute bottom-0 ${isRTL ? 'right-0' : 'left-0'} z-10 w-full`}
        alt={t('performanceTracking.backgroundAlt')}
        src="/Layer-Two.svg"
      />
      <img
        className={`absolute bottom-0 ${isRTL ? 'right-0' : 'left-0'} -z-0`}
