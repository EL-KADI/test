      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="grid lg:grid-cols-3 grid-cols-2 gap-12">
          <div className="bg-white rounded-lg shadow-[0_0_20px_0_rgba(0,0,0,0.08)] p-4 flex items-center justify-center gap-4 flex-col shadow-light transition hover:scale-105">
            <Image src="/Sucuri.svg" alt={t("featuresSection.sucuriAlt")} width={120} height={80} className="w-48" />
          </div>
          <div className="bg-white rounded-lg shadow-[0_0_20px_0_rgba(0,0,0,0.08)] p-4 flex items-center justify-center gap-4 flex-col shadow-light transition hover:scale-105">
          ...
          <div className="bg-white rounded-lg shadow-[0_0_20px_0_rgba(0,0,0,0.08)] p-4 flex items-center justify-center gap-4 flex-col shadow-light transition hover:scale-105">
            <Image src="/Cpanel-vs.svg" alt={t("featuresSection.cpanelAlt")} width={120} height={80} className="w-48" />
          </div>
          <div className="bg-white rounded-lg shadow-[0_0_20px_0_rgba(0,0,0,0.08)] p-4 flex items-center justify-center gap-4 flex-col shadow-light transition hover:scale-105">
            <Image src="/Plesk.svg" alt={t("featuresSection.pleskAlt")} width={120} height={80} className="w-64" />
          </div>
          <div className="bg-white rounded-lg shadow-[0_0_20px_0_rgba(0,0,0,0.08)] p-4 flex items-center justify-center gap-4 flex-col shadow-light transition hover:scale-105">
            <Image src="/Acronis.svg" alt={t("featuresSection.acronisAlt")} width={120} height={80} className="w-44" />
          </div>
          <div className="bg-white rounded-lg shadow-[0_0_20px_0_rgba(0,0,0,0.08)] p-4 flex items-center justify-center gap-4 flex-col shadow-light transition hover:scale-105">
