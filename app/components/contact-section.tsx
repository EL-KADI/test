...
const ContactSection = () => {
  ...
  return (
    <div dir={isRTL ? 'rtl' : 'ltr'} className="container mt-12 max-w-sm sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl mx-auto">
      <p className="text-center">
        {t('contactSection.description')}
      </p>
<div className="grid grid-cols-3 lg:grid-cols-5 gap-2 mt-12 mx-auto"><div><img alt="شعار الشريك" loading="lazy" width={0} height={0} decoding="async" data-nimg={1} className="w-full h-auto" style={{color: 'transparent'}} src="/Microsoft.svg" /></div><div><img alt="شعار الشريك" loading="lazy" width={0} height={0} decoding="async" data-nimg={1} className="w-full h-auto" style={{color: 'transparent'}} src="/google.svg" /></div><div><img alt="شعار الشريك" loading="lazy" width={0} height={0} decoding="async" data-nimg={1} className="w-full h-auto" style={{color: 'transparent'}} src="/jelastic.svg" /></div><div><img alt="شعار الشريك" loading="lazy" width={0} height={0} decoding="async" data-nimg={1} className="w-full h-auto" style={{color: 'transparent'}} src="/kaspesky.svg" /></div><div className="w-[65%] ms-5 sm:ms-7"><img alt="شعار الشريك" loading="lazy" width={0} height={0} decoding="async" data-nimg={1} className="w-full h-auto" style={{color: 'transparent'}} src="/Cpanel-vs.svg" /></div></div>
