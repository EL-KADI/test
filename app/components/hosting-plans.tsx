    ...
    <div className="min-h-screen bg-[#ffffff] p-8 relative overflow-hidden mx-auto mt-28" dir="rtl">
      ...
      <div className="container mx-auto relative z-10 max-w-6xl">
        ...
        <div className="mt-32 mx-auto">
          <div  dir={isRTL ? "rtl" : "ltr"} className="grid md:grid-cols-3 grid-cols-1 gap-8 mx-auto">
            <div>
              <h1 className="font-semibold  text-xl">{t("hostingPlans.virtualServersTitle")}</h1>
              <p className="mt-2 text-sm">{t("hostingPlans.virtualServersDescription")}</p>
            </div>
            <div>
