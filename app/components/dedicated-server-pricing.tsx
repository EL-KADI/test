...
// Flag components
const UsaFlag = () => <img alt="US Flag" src="/UsaFlag.svg" className="w-[42px] h-[42px]" />
const UKFlag = () => <img alt="UK Flag" src="/UKFlag.svg" className="w-[42px] h-[42px]" />
const AustraliaFlag = () => (
  <img alt="Australia Flag" src="/AustraliaFlag.svg" className="w-[42px] h-[42px]" />
)
...
const serverSpecs = [
    {
      icon: <CPUIcon />,
      title: t("dedicatedServerPricing.specs.cpu"),
      subtitle: t("dedicatedServerPricing.specs.cpuSubtitle"),
    },
    {
      icon: <StorageIcon />,
      title: t("dedicatedServerPricing.specs.storage"),
      subtitle: t("dedicatedServerPricing.specs.storageSubtitle"),
    },
    {
      icon: <DatabaseIcon />,
      title: t("dedicatedServerPricing.specs.database"),
      subtitle: t("dedicatedServerPricing.specs.databaseSubtitle"),
    },
    {
      icon: <RAMIcon />,
      title: t("dedicatedServerPricing.specs.ram"),
      subtitle: t("dedicatedServerPricing.specs.ramSubtitle"),
    },
    {
      icon: <BandwidthIcon />,
      title: t("dedicatedServerPricing.specs.bandwidth"),
      subtitle: t("dedicatedServerPricing.specs.bandwidthSubtitle"),
    },
    {
      icon: <ControlPanelIcon />,
      title: t("dedicatedServerPricing.specs.controlPanel"),
      subtitle: t("dedicatedServerPricing.specs.controlPanelSubtitle"),
    },
  ];
  ...
  const PricingCard = () => (
    <div className="bg-white rounded-lg overflow-hidden shadow-[0_0_20px_0_rgba(0,0,0,0.08)] max-w-6xl mx-auto">
      <div className="grid lg:grid-cols-3 grid-cols-1 lg:gap-8 border-b-2 border-opacity-15 shadow-[0_0_20px_0_rgba(0,0,0,0.08)]">
        {/* Server Info Section */}
        <div className="lg:pt-16 pt-8 lg:pb-16 pb-8 ltr:border-r-2 rtl:border-l-2 border-opacity-10">
          <div className="lg:ms-12 ms-6">
         <h1 className="font-semibold text-2xl">{t("dedicatedServerPricing.serverInfo.title")}</h1>
          <p className="font-light">{t("dedicatedServerPricing.serverInfo.subtitle")}</p>
        ...
        <div className="lg:pt-16 pt-8 lg:pb-16 pb-8  ">
          <div className="lg:ms-12 ms-6">
            <h1 className="font-semibold lg:text-6xl text-xl">$41.99</h1>
<p className="font-light">{t("dedicatedServerPricing.pricing.renewal")}</p>
            <div className="flex items-center gap-4 mt-6">
      ...
      <p>{t("dedicatedServerPricing.pricing.buyNow")}</p>       
              </div>
              <div className="bg-transparent text-[#2B1F51]  border-2 border-[#2B1F51]  hover:bg-[#2B1F51]  hover:text-white transition  px-6 py-2 w-fit cursor-pointer rounded-[10px]">
          <p>{t("dedicatedServerPricing.pricing.features")}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 lg:gap-x-8">
          {serverSpecs.map((spec, index) => (
            <div key={index} className="w-full relative ">
              <div className="flex items-center py-8 ms-8 gap-4 ltr:border-r-2 rtl:border-l-2 border-opacity-10 relative">
                {spec.icon}
                <div>
  ...
  return (
    <div className="mt-16">
<h1 className="lg:text-3xl text-xl mb-6 text-center font-bold">{t("dedicatedServerPricing.title")}</h1>
...
export default DedicatedServerPricing
